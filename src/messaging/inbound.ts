...
function generateMessageSid(): string {
  return generateId(WEIXIN_CHANNEL_ID);
}
...
export type WeixinMsgContext = {
  ...
  To: string;
  AccountId: string;
  OriginatingChannel: typeof WEIXIN_CHANNEL_ID;
  OriginatingTo: string;
  MessageSid: string;
  Timestamp?: number;
  Provider: typeof WEIXIN_CHANNEL_ID;
  ChatType: "direct";
...
export function weixinMessageToMsgContext(
  ...
  const ctx: WeixinMsgContext = {
    ...
    To: from_user_id,
    AccountId: accountId,
    OriginatingChannel: WEIXIN_CHANNEL_ID,
    OriginatingTo: from_user_id,
    MessageSid: generateMessageSid(),
    Timestamp: msg.create_time_ms,
    Provider: WEIXIN_CHANNEL_ID,
    ChatType: "direct",
  };
